...
- [RAG 介绍](#rag-介绍)
    - [LLM 问题](#llm-问题)
    - [RAG 原理](#rag-原理)
    - [RAG 和 Fine-tune](#rag-和-fine-tune)
- [RAG 模块](#rag-模块)
- [RAG 流程](#rag-流程)
- [RAG 实现](#rag-实现)
    - [向量化](#向量化)
...
缺乏专业领域的深度洞察，同时在推理能力上也有所欠缺。

正是在这样的背景下，检索增强生成技术（Retrieval-Augmented Generation，RAG）应时而生，
成为 AI 时代的一大趋势。

RAG 通过在语言模型生成答案之前，先从广泛的文档数据库中检索相关信息，然后利用这些信息来引导生成过程，
极大地提升了内容的准确性和相关性。RAG 有效地缓解了幻觉问题，提高了知识更新的速度，
并增强了内容生成的可追溯性，使得大型语言模型在实际应用中变得更加实用和可信。
...
> LLMs API
>
> LLM API 调用介绍在[这里](https://wangzhefeng.com/note/2024/08/14/llm-models-api/)。
...
* [Tiny RAG](https://github.com/datawhalechina/tiny-universe/tree/main/content/TinyRAG)
