...
- [时间序列的研究领域](#时间序列的研究领域)
  - [时间序列预测](#时间序列预测)
    - [时间序列预测-Time Series Forecasting](#时间序列预测-time-series-forecasting)
    - [时空预测-Spatio-temporal Forecasting](#时空预测-spatio-temporal-forecasting)
    - [超出概率预测-Exceedance Probability Forecasting](#超出概率预测-exceedance-probability-forecasting)
  - [时间序列异常检测](#时间序列异常检测)
  - [时间序列分类](#时间序列分类)
  - [时间序列检索](#时间序列检索)
  - [时间序列分割](#时间序列分割)
...
通常一组时间序列的时间间隔为一个恒定值(如 1s，5s，1min，1h，1d 等)。
...
* 第一个隐含在及时这个词中。该表达式意味着在发出有关即将发生的感兴趣事件的警报点与事件发生或开始的点之间存在适当的警告期。
